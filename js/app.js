        ...
        servizi: [
            ...
            
            {
                ...
                contenido: [
                    ...
                    {
                        texto: 'È fondamentale che il terapeuta riconosca, dapprima, ed interpreti correttamente, poi, gli elementi che rimandano alla sofferenza mentale del paziente, al fine di delineare un percordo di presa in carico mirato, attraverso cui sia possibile accompagnare il paziente stesso ad avvicinarsi ai propri sintomi, a coglierne i significati e ad imparare a formulare attorno ad essi un pensiero.'
                    },
                    {
                        texto: 'Gli strumenti di cui il professionista si avvale, in un percorso psicodiagnostico, includono l’osservazione partecipe e qualificata, i colloqui clinici, ma anche gioco, disegno e testistica, proiettiva e/o cognitiva.'
                    },
                    {
                        texto: 'Nel percorso psicodiagnostico in età evolutiva è molto importante il coinvolgimento delle figure genitoriali e di chi si prende cura del minore, allo scopo di comprendere al meglio le dinamiche familiari e progettare insieme la presa in carico più idonea.'
                    }
                ]
            },
...

            {
                ...
                contenido: [
                    ...
                    {
                        texto: 'Tematiche ricorrenti sono l’educazione all’affettività, la gestione e l’espressione delle emozioni e dei conflitti, la sensibilizzazione verso le disabilità, ma anche l’educazione stradale e l’abuso di sostanze.'
                    },
                    {
                        texto: 'Alcuni degli interventi, in contesto scolastico, vengono proposti sulla base di una specifica richiesta da parte del corpo docente, laddove siano state rilevate difficoltà di gestione del singolo o del gruppo classe.'
                    },
                    {
                        texto: 'Durante gli incontri, a partire da un livello informativo, si lavora affinché i ragazzi possano imparare a collaborare tra loro, cooperando in maniera efficace, promuovendo, pertanto, competenze indispensabili al vivere sociale. A tale scopo si ricorre all’utilizzo di tecniche di conduzione del gruppo, tra cui il cirle time, la peer education, lo psicodramma.'
                    },
                    {
                        texto: 'Lo studio AMPIA organizza laboratori e incontri presso associazioni territoriali e scuole di ogni ordine e grado.'
                    }
                ]
            }
        ]
